...
> Pour les procédures APOC (Dijkstra, betweenness, subgraphAll…) et les détails GDS, voir [APOC](../avance/apoc.qmd).
...
- [APOC](../avance/apoc.qmd) — procédures algorithmiques et GDS
