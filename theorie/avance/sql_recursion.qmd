...
→ même résultat, **2 lignes**, et la traversée est en `O(1)` par saut grâce à l'**index-free adjacency** (cf. [GraphDB 101](../outils/graphdb_101.qmd)).
...
→ Détails dans [APOC](apoc.qmd#lire-un-plan-cypher--profile).
...
- [GraphDB 101](../outils/graphdb_101.qmd) — pourquoi la traversée graphe est en `O(1)`
- [APOC](apoc.qmd) — algorithmes côté Cypher
- [pgRouting et r2gg](../outils/pgrouting.qmd) — Dijkstra sous SQL
