...
- [SQL — limites & EXPLAIN](../theorie/avance/sql_recursion.qmd) — pour la T1 ontologique
...
**Questions à creuser**
- Pourquoi `WITH RECURSIVE` est-il *plus verbeux* que `(d)-[:EST_SOUS_TYPE_DE*]->(o)` en Cypher ? (cf. [SQL — limites](../theorie/avance/sql_recursion.qmd))
