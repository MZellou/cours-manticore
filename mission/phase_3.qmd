...
- [APOC — algorithmes de graphe](../theorie/avance/apoc.qmd) — `betweenness`, `subgraphAll`, `allShortestPaths` (essentiel)
- [SQL — limites & EXPLAIN](../theorie/avance/sql_recursion.qmd) — lire un plan `EXPLAIN ANALYZE` / `PROFILE`
