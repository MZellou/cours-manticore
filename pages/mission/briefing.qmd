...
## Composition (35 étudiants / ~12 groupes × 3 agents)
...
|-------|----------|-------------|-------|----------|
| 🔍 Phase 1 | Reconnaissance | Solo (par rôle) | 6h | Requêtes SQL + table `mission_pois` + questions bonus |
| 🗺️ Phase 2 | Cartographie | Groupe (3 rôles fusionnés) | 5h | Graphe Neo4j + routes pgRouting + Cypher avancé |
...
- **Carte PNG** : situation tactique consolidée (3 rôles superposés)
