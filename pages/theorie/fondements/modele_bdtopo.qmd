...
> **Note** : toutes les centrales ne sont pas dans BDTOPO — seules celles présentes comme `zone_d_activite_ou_d_interet` y figurent. Pour les centrales proches de votre EPCI mais hors de son périmètre, utilisez un rayon de recherche (`ST_DWithin`).
