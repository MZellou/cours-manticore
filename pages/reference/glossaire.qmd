...
### `mission_pois` (table partagée 4 rôles — pattern accumulation)

`mission_pois` est la table **commune** où les 4 agents (Attaque, Défense, Ravitaillement, Énergie) déposent leurs POIs. Elle persiste entre les exécutions du script `01_explore_postgis.py`.
...
mission_pois (
    ...
    role TEXT,           -- 'attaque' | 'defense' | 'ravitaillement' | 'energie'
...
- Lancer les 4 rôles successivement → **tous les 4** coexistent dans la table.
